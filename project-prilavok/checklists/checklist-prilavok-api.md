...
|------|--------------------------------------------------------------------------------------------------|------------------------------------|--------|-----------------------|
| T1   | Возможность добавления 1 товара в пустой набор.                            | Код и статус ответа 200 ОК.        | Passed |                       |
| T2   | Возможность добавления 15 товаров в пустой набор.                          | Код и статус ответа 200 ОК.        | Passed |                       |
| T3   | Возможность добавления 29 товаров в пустой набор.                          | Код и статус ответа 200 ОК.        | Passed |                       |
| T4   | Возможность добавления 30 товаров в пустой набор.                          | Код и статус ответа 200 ОК.        | Passed |                       |
| T5   | Появление ошибки при добавлении 31 товара в пустой набор.                  | Код и статус ответа 400 Bad Request. | Passed |                       |
